...
SS_notification_tests = {
	...
	notification: {
		...
		'test - when I book a viewing, these variables should be POSTed: the event XML as "content", the email address of the person who booked the viewings as "booked_by", the property address as "address" and the booking datetime as "booking_datetime"', function() {
			fail();
		}
	}
};
